...
const USERS = [
  {
    email: "admin@cognitiaxai.com",
    password: "Kuldeep@9599",
    role: "Owner",
    name: "Kuldeep Singh",
  },
  {
    email: "imran@cognitiaxai.com",
    password: "Imran@9870",
    role: "Admin",
    name: "Imran Shaikh",
  },
...
function Login({ onLogin }) {
  ...
  const handleSubmit = (event) => {
    ...
    window.setTimeout(() => {
      ...
      localStorage.setItem("cognitiax_crm_logged_in", "true");
    ...
    <div className="cx-login-page">
      ...
      <section className="cx-login-showcase">
        <div className="cx-login-showcase-inner">
          <div className="cx-login-brand-row">
            ...
            <div>
              <div className="cx-login-brand-name">
                CognitiaX AI
              </div>

              <div className="cx-login-brand-caption">
                Institute CRM
              </div>
            </div>
          </div>
          ...
          <div className="cx-login-showcase-copy">
            ...
            <p>
              Manage students, admissions, batches, fees, payments,
              attendance and WhatsApp communication from one clean
              workspace.
            </p>
          </div>
          ...
          <div className="cx-login-feature-list">
            <div className="cx-login-feature-card">
              ...
              <div>
                ...
                <span>
                  Admissions, batches and student records.
                </span>
              </div>
            </div>
            ...
            <div className="cx-login-feature-card">
              ...
              <div>
                ...
                <span>
                  Personal reminders and batch announcements.
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="cx-login-form-area">
        ...
        >
          ...
          <div className="cx-login-field">
            <label htmlFor="crm-login-password">
              Password
            </label>
          ...
          <div className="cx-login-footer">
            <span>
              © {new Date().getFullYear()} CognitiaX AI
            </span>

            <span className="cx-admin-chip">
              Administrator
            </span>
          </div>
        </form>
